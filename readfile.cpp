            ...
            if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
                ...
                if (cmd == "light") {
                    if (numused == numLights) { // No more Lights 
                        ...
                        if (validinput) {
							...
							memcpy( &lightposn[4*numused], &values[0], sizeof(GLfloat)*4);//4方向のベクトルのメモリ確保
							memcpy( &lightcolor[4*numused], &values[4], sizeof(GLfloat)*4);
                ...
                // Note that no transforms/stacks are applied to the colors. 
                    ...
                    if (validinput) {
                        ...
                        // to set up correctly. 
                        // Set eyeinit(values0~3) upinit center fovy in variables.h 
                ...
                // Also look at demo.txt to get a sense of why things are done this way.
                    ...
                    if (validinput) {
						...
						transfstack.top() = transfstack.top()*mat4(rot);
                    }
                }
